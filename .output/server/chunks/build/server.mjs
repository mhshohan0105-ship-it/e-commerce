import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { toRef, isRef, hasInjectionContext, getCurrentInstance, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, inject, computed, unref, shallowReactive, ref, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, withCtx, nextTick, isReadonly, toRaw, useSSRContext, isShallow, isReactive } from 'vue';
import { l as parseURL, m as encodePath, n as decodePath, o as hasProtocol, q as isScriptProtocol, k as joinURL, w as withQuery, r as sanitizeStatusCode, v as getContext, $ as $fetch, x as baseURL, y as defu, z as createHooks, i as createError$1, A as executeAsync, B as getHeader, C as setCookie } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "cart",
    path: "/cart",
    component: () => import('./cart-xlmVHY8n.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DihHZLX3.mjs')
  },
  {
    name: "account",
    path: "/account",
    component: () => import('./account-2JykANcj.mjs')
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import('./checkout-CnnoLsqS.mjs')
  },
  {
    name: "products-id",
    path: "/products/:id()",
    component: () => import('./_id_-Bf4vi4iS.mjs')
  },
  {
    name: "categories-slug",
    path: "/categories/:slug()",
    component: () => import('./_slug_-BzJBhbX5.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-D1q9zGdH.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-B4VteNO2.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BtsAAoOa.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CytfrPoI.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-C7mNSDNz.mjs'));
...
export { _export_sfc as _, useRuntimeConfig as a, useRequestEvent as b, useRouter as c, nuxtLinkDefaults as d, entry_default as default, encodeRoutePath as e, useState as f, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useNuxtApp as u };
